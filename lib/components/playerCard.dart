...
import 'package:player_stats_23/screens/PlayerDetails.dart';
        ...
        child: Row(
          children: [
            ...
            Container(
                ...
                height: queryData.size.width * 0.11,
                child: FadeInImage(
                  image: NetworkImage(widget.playerData['player_face_url']),
                  placeholder: AssetImage("assets/images/player_icon.webp"),
