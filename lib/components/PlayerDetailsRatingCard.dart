import 'package:player_stats_23/components/AgeRating.dart';
import 'package:player_stats_23/components/FootDetails.dart';
import 'package:player_stats_23/components/OverallRating.dart';
import 'package:player_stats_23/components/PotentialRating.dart';
        ...
        children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        width: remWidth * 0.32,
                        child: FadeInImage(
                          image: NetworkImage(playerData['player_face_url']),
                          placeholder:
                              AssetImage("assets/images/player_icon.webp"),
          ...
          Center(
            child: Row(
              ...
              crossAxisAlignment: CrossAxisAlignment.center,
              children: [
                playerData['nation_flag_url'].length > 1
                    ? Container(
